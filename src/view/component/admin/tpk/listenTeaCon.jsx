 ...
 * @Last Modified time: 2019-03-20 10:02:09
...
import './../../../../css/admin/mj_listenTeaCon.css';
  ...
  componentDidMount() {
    RequestMultiple([{
      ...
      success: (ret => {
        ...
        //   result: true,
        //   data: [
        //     { teacherId: "2018001", teacherName: "刘瑶", relaTeachers: [], firstLetter: "L" },
        //     { teacherId: "2018045", teacherName: "吴六", relaTeachers: [], firstLetter: "W" }
        //   ]
        // }
        if (ret.result) {
          if (this._isMounted) {
      ...
      success: (ret => {
        ...
        //   result: true,
        //   data: [
        //     { teacherName: "哈士奇", teacherId: "2018047", nameStartChat: "H" },
        //     { teacherName: "吉娃娃", teacherId: "2018049", nameStartChat: "J" },
        //     { teacherName: "金毛", teacherId: "2018051", nameStartChat: "J" },
        //     { teacherName: "林俊杰", teacherId: "2018002", nameStartChat: "L" },
        //     { teacherName: "林忆莲", teacherId: "2018007", nameStartChat: "L" },
        //     { teacherName: "刘瑶", teacherId: "2018001", nameStartChat: "L" },
        //   ]
        // }
        if (ret.result) {
          if (this._isMounted) {
    ...
    return (
      <div>
        <Row>
          ...
          <Col span={3} className='zq-ltc-next'><SVG type='icon' /></Col>
          <Col span={10}>
            <div className='zq-lpc-container'>
