 ...
 * @Last Modified time: 2019-03-26 10:51:56
...
import ListenTopTeas from './../../../component/admin/tpk/listenTopTeas';
import ListenAppliCom from './../../../component/admin/tpk/listenAppliCom';
import TpkManaOverListenerInfo from './../../../page/admin/tpk/sttrw/tpkManaOverListenerInfo';

import './../../../../css/admin/mj_listenTopTotal.css';
    ...
    return (
      <div className='mj-ltt-topCon'>
        <div className='mj-ltt-tit'>
          <span>随堂听开展情况</span>
          <Link to='/admin/tpk/sttrw/TpkManaOverListenerInfo'>
            {/* <div onClick={() => {this.props.history.push('/admin/tpk/sttrw/TpkManaOverListenerInfo');console.log(this)}}> */}
            <SVG type='xiangzuo' />
            {/* </div> */}
          </Link>
        </div>
