 ...
 * @Last Modified time: 2019-03-14 14:28:43
 */
...
import './../../../../css/admin/mj_reChoseLesson.css';
...
class ReChoseLesson extends Component {
  ...
  getLessonTable = (classId, curWeek, CurSstm) => {
    ...
    // Request('/research_lesson/setting/get_curriculum', req, function (ret) {
    // console.log(ret);
    const ret = {
      result: true,
      data: []
