 ...
 * @Last Modified time: 2019-03-14 14:06:09
 *  教研课任务情况组件
 */
...
import './../../../../css/admin/mj_researchLesson.css';
    ...
    return (
      <div className="cjy-rl-researchLesson">
        <div className="cjy-rl-title cjy-rl-clearfix">
          ...
          <Link to='/admin/tpk/jyrw/reLessonDe' className="cjy-rl-toDetail"><Icon className="cjy-rl-right" type="right" /></Link>
        </div>
