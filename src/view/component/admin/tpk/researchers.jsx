 ...
 * @Last Modified time: 2019-03-12 15:23:16
 * 教研员任务情况组件
 */
...
import ListenTeaInfo from './listenTeaInfo';
import './../../../../css/admin/mj_researchers.css';
    ...
    return (
      <div className="cjy-r-researchers">
        <div className="cjy-r-title cjy-r-clearfix">
          ...
          <Link to='/admin/tpk/jyrw/rePerDe' className="cjy-r-toDetail"><Icon className="cjy-r-right" type="right" /></Link>
        </div>
