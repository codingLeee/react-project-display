 ...
 * @Last Modified time: 2017-10-13 12:57:13
            ...
            <div className={'mj-lti-perCon'}>
              ...
              <div className='mj-lti-headImg'>
                {
                  this.props.thePer === 'mj'
                    ?
                    <Link to={`/lisTasks/TpkManaLisInfo/t${this.props.data.teacherName}/${this.props.data.teacherId}`}>
                      <Avatar className='mj-lti-uhead' />
                    </Link>
                    :
                    <Link to={`/reTasks/reLessonDe/reId=${this.props.data.id}&reName=${this.props.data.teacherName}`}>
                      <Avatar className='mj-lti-uhead' />
                    </Link>
                }
              </div>
              ...
              <div className='mj-lti-perInfo'>
                ...
                </div>
                {
                  this.props.thePer === 'mj'
                    ?
                    <Link to={`/lisTasks/ListenNote/f${this.props.data.teacherId}/${this.props.data.teacherName}`}>
                      <i className='mj-lti-link'>查看听课本</i>
                    </Link>
                    :
                    <Link to={`/reTasks/reBook/${this.props.data.id}/${this.props.data.teacherName}`}>
