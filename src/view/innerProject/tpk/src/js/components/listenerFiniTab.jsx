 ...
 * @Last Modified time: 2017-10-18 15:17:28
    ...
    const columns = [
      {
        ...
        render: (text, record, index) => (
          <span>
            <Link to={`/lisTasks/TpkManaLisInfo/a${record.teacherName}/${record.teacherId}`}>
              <i className='iconfont mj-lot-icon1' title='详情'>&#xe62f;</i>
            </Link>
            <Link to={`/lisTasks/ListenNote/b${record.teacherId}/${record.teacherName}`}>
