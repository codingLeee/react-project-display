 ...
 * @Last Modified time: 2017-12-20 17:03:47
 */
import React, { Component } from 'react';
import ClassItem from './classItem';
import '../../css/components/researchClassTable.css';
          ...
          <div className="cjy-rct-classNum">
            {
              classDataArray.map((item,index)=>(
                <ClassItem key={index} text={`第${Number(index + 1).toChinese()}节`} color="grey"></ClassItem>
              ))
            }
          </div>
          <div className="cjy-rct-classTable">
            {
              classDataArray.map((item,index)=>{
                ...
                classDataArray[index].map((item,index)=>{
                  ...
                  ? (<ClassItem text="" color="dsbd"></ClassItem>)
