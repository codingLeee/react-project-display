 ...
 * @Last Modified by: 蒲飞
 * @Last Modified time: 2017-10-20 16:45:57
 * 我的教研课--教研课查询--查询的内容
 */
        ...
        <div className="pf-r-searchcontent">
          <div className="pf-t-schtypes pf-r-searchtypes">
            <ul className="pf-t-schtitltleft">
              <li onClick={this.onhandlechangecolor.bind(this, 1)}><span className={this.state.isredselected ? 'pf-t-schtitletype zq-r-redselected' : 'pf-t-schtitletype zq-r-grayselected'} ></span><span className="pf-t-schtype">未完成的评课</span></li>
              <li onClick={this.onhandlechangecolor.bind(this, 2)}><span className={this.state.isgreenselected ? 'pf-t-schtitletype zq-r-greenselected' : 'pf-t-schtitletype zq-r-grayselected'}></span><span className="pf-t-schtype">已完成的评课</span></li>
              <li onClick={this.onhandlechangecolor.bind(this, 3)}><span className={this.state.isorangeselected ? 'pf-t-schtitletype zq-r-orangeselected' : 'pf-t-schtitletype zq-r-grayselected'}></span><span className="pf-t-schtype">未开始的评课</span></li>
              <li onClick={this.onhandlechangecolor.bind(this, 4)}><span className={this.state.isblueselected ? 'pf-t-schtitletype zq-r-blueselected' : 'pf-t-schtitletype zq-r-grayselected'}></span><span className="pf-t-schtype">我的教研授课</span></li>
            </ul>
          </div>
          {/* 没有数据提示 */
