 ...
 * @Last Modified by: 蒲飞
 * @Last Modified time: 2017-10-20 13:47:16
 * 我申请的随堂听 
 */
...
import '../../css/components/tasksMyApplyListen.css';
import {iconfont} from '../../font/iconfont.svg'
...
class TasksMyApplyListen extends Component{
  ...
  render(){
    ...
    let href=`${Global.rootpath}/home#resr1/${this.props.afterApplyCntPath}/2`;
            ...
            <div className="pf-tk-list pf-tk-applist">
              <Row align="middle">
                ...
                <Col span={7}>
                  ...
                  <Link to="/tasks/tpkTeachTasksApplyListen"><Button type="primary" size="large" className="pf-t-greenbutton">去申请</Button></Link> 
                  </div>
                </Col>
              </Row>
              <Row align="middle">
              ...
              <Col span={7}>
                <div className="pf-tk-gutter">
                {
                  this.props.afterApplyCnt==1?<a onClick={this.handleHref.bind(this,href,startTime,lessonStartTime)}><i className='iconfont pf-t-iconstyle'>&#58889;</i></a>:
                  <Link to="/myListen"><i className='iconfont pf-t-iconstyle'>&#58927;</i></Link>                                      
                } 
                </div>
              </Col>
            </Row>
...
export default TasksMyApplyListen;
