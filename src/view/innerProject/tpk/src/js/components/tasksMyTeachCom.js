 ...
 * @Last Modified by: 蒲飞
 * @Last Modified time: 2017-10-20 10:18:24
 * 我的教研评课
 */
...
import { info} from '../components/base/modal.jsx';
import '../../css/components/tasksMyTeachCom.css'
...
class TasksMyTeachCom extends Component{
  ...
  handleTodayHref(hrefToday,startTimeToday,lessonStartTimeToday){
    ...
    if(startTimeToday>timestamp){
      info('提示框',`该课程尚未开始，请于${lessonStartTimeToday}查看！`,3000);
    }else{
  ...
  handleFinishHref(hrefFinish,startTimeFinish,lessonStartTimeFinish){
    ...
    if(startTimeFinish>timestamp){
      info('提示框',`该课程尚未开始，请于${lessonStartTimeFinish}查看！`,3000);
    }else{
  ...
  render(){
    var hrefToday=`${Global.rootpath}/home#resr1/${this.props.tadayComCntPath}/1`;
    var hrefFinish=`${Global.rootpath}/home#resr1/${this.props.noComFinishCntPath}/1`;
            ...
            <div className="pf-tk-list">
              <Row align="middle">
                ...
                <Col span={6}>
                  ...
                  {
                    this.props.tadayComCnt==1?<a onClick={this.handleTodayHref.bind(this,hrefToday,startTimeToday,lessonStartTimeToday)}><i className='iconfont pf-t-iconstyle'>&#58889;</i></a>:
                    <Link to="/myResearch"><i className='iconfont pf-t-iconstyle'>&#58927;</i></Link>                                      
                  } 
                  </div>
                </Col>
              </Row>
              ...
              <Col span={6}>
                <div className="pf-tk-gutter pf-tk-icon">
                {
                  this.props.noComFinishCnt==1?<a onClick={this.handleFinishHref.bind(this,hrefFinish,startTimeFinish,lessonStartTimeFinish)}><i className='iconfont pf-t-iconstyle'>&#58889;</i></a>:
                  <Link to="/myResearch"><i className='iconfont pf-t-iconstyle'>&#58927;</i></Link>                                      
                }
                </div>
              </Col>
